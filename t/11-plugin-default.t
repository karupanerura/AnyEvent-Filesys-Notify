...
use Test::Without::Module qw(Linux::Inotify2 Mac::FSEvents Filesys::Notify::KQueue);
...
SKIP: {
    skip 'Test for Mac/Linux only', 1 unless $^O eq 'linux' or $^O eq 'darwin' or $^O eq 'freebsd';
